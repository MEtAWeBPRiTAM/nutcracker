...
@app2.on_message(filters.command("availablebots"))
...
@app2.on_message(filters.command("keepthetext"))
...
@app2.on_message(filters.command("deletethetext"))
...
@app2.on_message(filters.command("keepthepicture"))
...
@app2.on_message(filters.command("deletethepicture"))
...
@app2.on_message(filters.command("getmyid"))
